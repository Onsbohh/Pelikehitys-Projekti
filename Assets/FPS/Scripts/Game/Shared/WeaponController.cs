...
namespace Unity.FPS.Game
{
    ...
    public class WeaponController : MonoBehaviour
    {
        ...
        public float LastCastTriggerTimestamp { get; private set; }
        ...
        bool TryBeginCast()
        {
            if (!IsCasting && m_LastTimeShot + DelayBetweenShots < Time.time)
            {
                IsCasting = true;
                LastCastTriggerTimestamp = Time.time;
